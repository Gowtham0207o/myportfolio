                ...
                <div class="portfolio-container"> 
                    <div class="col-md-6 col-lg-4 web new">
                        <div class="portfolio-item">
                            ...
                            <img src="/images/logo.ico" class="img-fluid" alt="Download free bootstrap 4 admin dashboard, free boootstrap 4 templates">
                            <div class="content-holder">
                                <a class="img-popup" href="/images/logo.ico"></a>
                                <div class="text-holder">
                                <a href="https://auth.selfmade.technology/app">
                                    <h6 class="title" style="color:white">WEB APP</h6>
                                    <p class="subtitle">a basic photo posting webapp</p>
                                </a>
                                </div>
                            </div>   
                        </div>             
