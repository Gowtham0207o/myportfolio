<header class="header">
        ...
        <div class="typewriter">
                ...
                <h1 class="header-title" style="padding: right 200px;">Gowtham</h1>
                <h6 class="header-mono" >Back End Developer | Civil Engineer</h6>
                <h4 id="effect"></h4>
                <button class="btn btn-primary btn-rounded"><i class="ti-printer pr-2"></i><a href="/images/resume.jpeg" download style="color:white">Print Resume</a></button>
            <center
        >
            </div>
        </div>
