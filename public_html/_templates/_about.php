        ...
        <div id="about" class="row about-section">
            ...
            <div class="col-lg-4 about-card">
                ...
                <ul class="mt40 info list-unstyled">
                    <li><span>Birthdate</span> : 02/07/2003</li>
                    <li><span>Email</span> : gowthamravi032@gmail.com</li>
                    <li><span>Phone</span> : +919600620266</li>
                    <li><span>Github</span> : Gowtham0207o </li>
            ...
            <div class="col-lg-4 about-card">
                ...
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        <h6>UX Design</h6>
                        <p class="subtitle">A better UX Designer in webapps/websites </p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        ...
                        <p class="subtitle">A proper web developer with secured Development</p>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-10 ml-auto mr-3">
                        ...
                        <p class="subtitle">pursuing under graduate degree in BE civil engineering</p>
                        <hr>
                    </div>
                </div>
            </div>
